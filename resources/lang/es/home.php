...
/*     'text-3' => 'Prestamos especial atención a la calidad de los servicios y utilizamos solo productos cosméticos probados. En nuestro salón puede estar seguro de la seguridad y calidad de los procedimientos.',
  ...
  'saloon' => [
    ...
    'title-h2' => 'NUESTRO ÚLTIMO TRABAJO',

    'card-one-title' => 'PESTAÑAS',
    'card-one-text' => 'Lorem Ipsum - texto tse - "riba", que es victorioso',

    'card-two-title' => 'PESTAÑAS',
    'card-two-text' => 'Lorem Ipsum - texto tse - "riba", que es victorioso',

    'card-three-title' => 'PESTAÑAS',
    'card-three-text' => 'Lorem Ipsum - texto tse - "riba", que es victorioso',

    'card-four-title' => 'PESTAÑAS',
    'card-four-text' => 'Lorem Ipsum - texto tse - "riba", que es victorioso',

    'card-five-title' => 'PESTAÑAS',
    'card-five-text' => 'Lorem Ipsum - texto tse - "riba", que es victorioso',

    'btn-text' => 'Ver más obras',
  ],
  'reviews' => [
    'title-h3' => 'RESEÑAS',
    'title-h2' => 'CLIENTES SOBRE NOSOTROS',
  ],
  'spollers' => [
  ...
  'read-more' => [
    ...
    'text' => 'Todas las chicas periódicamente quieren sentir el placer de visitar un salón de belleza. De hecho, es extremadamente útil. El estudio de belleza Ulash ha reunido a los mejores especialistas en su nicho. Trabajan en cada dama para que salga del salón con un aspecto impecable. ¿Por qué visitar un estudio de belleza? La atención profesional que se ofrece en el salón no solo mejora la imagen, sino que también genera emociones positivas y oportunidades únicas. En la persona de los maestros, puede encontrar buenos amigos y, entre otros clientes, conexiones útiles. En este lugar puedes alzar la voz, pedir consejos sobre cómo actuar en una situación particular. Todas las chicas periódicamente quieren sentir el placer de visitar un salón de belleza. De hecho, es extremadamente útil. El estudio de belleza Ulash ha reunido a los mejores especialistas en su nicho. Trabajan en cada dama para que salga del salón con un aspecto impecable. ¿Por qué visitar un estudio de belleza? La atención profesional que se ofrece en el salón no solo mejora la imagen, sino que también genera emociones positivas y oportunidades únicas. En la persona de los maestros, puede encontrar buenos amigos y, entre otros clientes, conexiones útiles. En este lugar puedes alzar la voz, pedir consejos sobre cómo actuar en una situación particular. Todas las chicas periódicamente quieren sentir el placer de visitar un salón de belleza. De hecho, es extremadamente útil. El estudio de belleza Ulash ha reunido a los mejores especialistas en su nicho. Trabajan en cada dama para que salga del salón con un aspecto impecable. ¿Por qué visitar un estudio de belleza?',
    'btn-text' => 'LEER MÁS',
  ],
]
?>

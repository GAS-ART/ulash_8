    ...
    <div class="services-price__wrapper">
      ...
      <div class="services-price__box">
        ...
        <ul class="services-price__list">
          ...
          <li class="services-price__item">
            <p class="services-price__text">@lang('brows.price.sect-one.li-seven')</p>
            <span class="services-price__price">10 €</span>
          </li>
      ...
      <div class="services-price__box">
        ...
        <ul class="services-price__list">
          ...
          <li class="services-price__item">
            <p class="services-price__text">@lang('brows.price.sect-three.li-seven')</p>
            <span class="services-price__price">10 €</span>
          </li>

          <li class="services-price__item">
            <p class="services-price__text">@lang('brows.price.sect-three.li-eight')</p>
            <span class="services-price__price">10 €</span>
          </li>

          <li class="services-price__item">
            <p class="services-price__text">@lang('brows.price.sect-three.li-nine')</p>
            <span class="services-price__price">10 €</span>
          </li>

          <li class="services-price__item">
            <p class="services-price__text">@lang('brows.price.sect-three.li-ten')</p>
            <span class="services-price__price">10 €</span>
          </li>
        </ul>
      </div>
